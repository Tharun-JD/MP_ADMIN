          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                type="button"
                onClick={() => setIsIncentiveFilterOpen((current) => !current)}
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                type="button"
                onClick={() => setIsChannelFilterOpen((current) => !current)}
                aria-label="Open channel partner filter"
                className="flex items-center rounded-xl border border-[#1a79d1]/20 bg-white p-2 text-[#1a79d1]"
              >
                <Icon name="filter" className="h-5 w-5" />
              </button>
            </div>
            ...
            {isChannelFilterOpen && (
              <div
                ...
                className="mt-4 grid grid-cols-1 gap-3 rounded-xl border border-[#d6e5fb] bg-[#f8fbff]/90 p-4 shadow-inner sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_auto_auto]"
              >
                <input
                  type="text"
                ...
                <select
                  ...
                  onChange={(event) => setChannelPartner(event.target.value)}
                  className="w-full rounded-xl border border-[#a8c2e9] bg-white px-3 py-2 text-sm text-[#1f365d] outline-none focus:border-[#1a79d1] focus:ring-2 focus:ring-[#1a79d1]/25"
                >
                  <option value="">Channel Partner</option>
                  <option value="partner_a">Partner A</option>
                  <option value="partner_b">Partner B</option>
                  <option value="partner_c">Partner C</option>
                </select>
                <button
                  type="button"
                  onClick={() => {
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                type="button"
                onClick={() => setIsManagerFilterOpen((current) => !current)}
                aria-label="Open manager filter"
                className="flex items-center rounded-xl border border-[#2f3fa9]/20 bg-white p-2.5 text-[#2f3fa9]"
              >
                <Icon name="filter" className="h-5 w-5" />
              </button>
            </div>
